...
test.describe.serial('Testing the creation of a new client: ', () => {
    ...
    test('Creating a single new user successfully submits the data and returns to the Clients listing page: ', async ({page}) => {
        ...
        createdClientsNames.push(firstClientData.client_name);
    ...
    test('Search for, and find, the recently created client in the Clients listing page: ', async ({page}) => {
        ...
        // search results
        await expect(clientArea.searchWaitingSpinner).toBeVisible();
        await expect(clientArea.searchWaitingSpinner).toBeHidden();
